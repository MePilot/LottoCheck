...
import home.loto.Lotto_List777;
import home.loto.RW;
import home.loto.RW777;
 ...
 */
public final class OcrCaptureActivity777 extends BaseActivity implements Observer {
    ...
    OcrDetectorProcessor777 p=null;
    private TextView progressTextView;
    private ProgressBar progressBar;
    public static final String KEY_PREF_AMOUNT777 =  "amount_preference";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.ocr_capture777);
        ...
        seekbar.setProgress(prefs.getInt(KEY_PREF_AMOUNT777,0));
        progressTextView.setText(getString(R.string.txt_ocr_lines,String.valueOf(changeProgress(prefs.getInt(KEY_PREF_AMOUNT777,0)))));
        ...
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                editor.putInt(KEY_PREF_AMOUNT777, progress);
                editor.apply();
        ...
        // Snackbar.make(mGraphicOverlay, getString(R.string.msg_ocr),
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        p=new OcrDetectorProcessor777(mGraphicOverlay,this);
        p.setAmount(changeProgress(prefs.getInt(KEY_PREF_AMOUNT777,0)));
    ...
    public void update(Observable o, Object arg) {
        ...
        if (arg instanceof Set777) {
            RW777 rw =new RW777(this);
            ArrayList<Set777> pSets = rw.LoadPlaySets();
            Set777 pSet = (Set777) arg;
            pSets.add(pSet);
            rw.Save(pSets);

            Intent intent = new Intent(this, Lotto_List777.class);
