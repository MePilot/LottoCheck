...
public class AutoGridLayout extends GridLayout {
    /*This class modifies the default GridLayout to position the UI game results icons in more adequate and compact way.*/
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        /*Calculating column width in pixels and default column count.*/
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        /*Calculating and setting column count based on view total width.*/
